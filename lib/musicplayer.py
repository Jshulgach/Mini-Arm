...
mii_theme_notes = [NOTE_FS[4], REST, NOTE_A[4], NOTE_CS[5], REST, NOTE_A[4], REST, NOTE_FS[4], NOTE_D[4], NOTE_D[4], NOTE_D[4], REST,
                   REST, REST, NOTE_CS[4], NOTE_D[4], NOTE_FS[4], NOTE_A[4], NOTE_CS[5], REST, NOTE_A[4], REST, NOTE_F[4], NOTE_E[5],
                   NOTE_DS[5], NOTE_D[5], REST, REST, NOTE_GS[4], REST, NOTE_CS[5], NOTE_FS[4], REST, NOTE_CS[5], REST, NOTE_GS[4],
                   REST, NOTE_CS[5], REST, NOTE_G[4], NOTE_FS[4], REST, NOTE_E[4], REST, NOTE_E[4], NOTE_E[4], NOTE_E[4], REST,
                   REST, NOTE_E[4], NOTE_E[4], NOTE_E[4], REST, REST, NOTE_DS[4], NOTE_D[4], NOTE_CS[4], REST]
mii_theme_beats = [8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 4, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 3, 7, 8, 8, 8, 4, 8,
                   8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 4, 8, 8, 8, 8, 8, 8, 8, 8]

#https://github.com/robsoncouto/arduino-songs/blob/master/starwars/starwars.ino
starwars_notes = [NOTE_AS[4], NOTE_AS[4], NOTE_AS[4], NOTE_F[5], NOTE_C[6], NOTE_AS[5], NOTE_A[5], NOTE_G[5], NOTE_F[6], NOTE_C[6], 
                  NOTE_AS[5], NOTE_A[5], NOTE_G[5], NOTE_F[6], NOTE_C[6], NOTE_AS[5], NOTE_A[5], NOTE_AS[5], NOTE_G[5], NOTE_C[5], 
                  NOTE_C[5], NOTE_C[5], NOTE_F[5], NOTE_C[6], NOTE_AS[5], NOTE_A[5], NOTE_G[5], NOTE_F[6], NOTE_C[6], NOTE_AS[5], 
                  NOTE_A[5], NOTE_G[5], NOTE_F[6], NOTE_C[6], NOTE_AS[5], NOTE_A[5], NOTE_AS[5], NOTE_G[5]]  
starwars_beats = [8, 8, 8, 2, 2, 8, 8, 8, 2, 4, 8, 8, 8, 2, 4, 8, 8, 8, 2, 8, 8, 8, 2, 2, 8, 8, 8, 2, 4, 8,
                  8, 8, 2, 4, 8, 8, 8, 2]

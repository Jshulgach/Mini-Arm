"""Unit tests for miniarm_core package."""
...
class TestMiniArmImports:
    ...
    def test_import_package(self):
        ...
        import miniarm_core
        assert hasattr(miniarm_core, 'MiniArmClient')
        assert hasattr(miniarm_core, '__version__')
    ...
    def test_version_format(self):
        ...
        from miniarm_core import __version__
...
class TestMiniArmClient:
    ...
    @patch('miniarm_core.client.serial.Serial')

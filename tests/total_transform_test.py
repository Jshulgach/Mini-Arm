...
# Ta and Tb are the same, but I still want to check that the forward kinematic transform gives me the 
...
# Now add the rotation transform to put it in the tool frame
...
print("\nT02")
print(simplify(T01 * T12).evalf(subs = {
  q1: 0.000,
  q2: 0.000,
  q3: 0.000,
  q4: 0.000,
